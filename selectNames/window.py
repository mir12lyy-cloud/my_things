...
tk.Label(selectMain, text='输入点的男生人数（不指定性别不用填）：').place(x=50, y=240)
...
cbtn_comfirm_sex = tk.Checkbutton(selectMain, text='指定性别', variable=var_user_selectwithsex, onvalue=True, offvalue=False)
...
btn_check_file.place(x=310, y=400)
btn_select_name = tk.Button(selectMain, text='点名', command=select_name)
btn_select_name.place(x=560, y=400)
